...
const { getAllUsers, createUser, updateUser,updateProfileHandler} = require("../controller/userController");
...
userRouter.patch("/updateProfile",upload.single("user"),protectRoute,updateProfileHandler)  // "upload.single("user")" => server par image add kar di & protectRoute => id nikaldi & updateProfileHandler => req.file ke anadr data chala gaya 
