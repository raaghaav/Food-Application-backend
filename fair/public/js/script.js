...
function typewriter(spandetector,client){
    ...
    function typer(){
        ...
        if(spandetector){// added this check b/c it is giving null => if features are present then only this will apply, before it was always applying, now only if features are there then 
...
window.addEventListener("scroll", function() {
    if(features){ // added this check b/c it is giving null => if features are present then only this will apply, before it was always applying, now only if features are there then
