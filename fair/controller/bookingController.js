...
async function createSession(req, res) { // will take planId & userId and creates a session 
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({ // from Stripe documentation 
